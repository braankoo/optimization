...
class CreateStatsAdGroups extends Migration {
    ...
    public function up()
    {
        ...
        {
            Schema::connection($adPlatform)->create('stats_ad_groups', function (Blueprint $table) {
                ...
                $table->primary([ 'ad_group_id', 'created_at' ]);
    ...
    function down()
    {
        foreach ( [ 'google', 'bing', 'gemini' ] as $adPlatform )
        {
            Schema::connection($adPlatform)->dropIfExists('stats_ad_groups');
        }
    }
}
